...
def create_kitti_info_file(data_path,
                           ...
                           relative_path=True):
    train_img_ids = _read_imageset_file("./data/kitti/train_kitti_reduced.txt")
    val_img_ids = _read_imageset_file("./data/kitti/train_kitti_reduced.txt")
    ...
    filename = save_path / 'kitti_infos_train_reduced.pkl'
    ...
    filename = save_path / 'kitti_infos_val_reduced.pkl'
