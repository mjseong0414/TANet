...
from second.data import kitti_common_JRDB as jrdb
...
def create_kitti_info_file(data_path,
    ...
    #data_path = "mnt/sdb/jrdb_3dteam/TANet/pointpillars_with_TANet/second/data/JRDB_to_KITTI/"
    data_path = "./data"
    ...
    val_img_ids = _read_imageset_file(data_path + target_val_img_ids)#
    ...
    save_path = data_path+"/JRDB_to_KITTI/"
    # if save_path is None:
    #     save_path = pathlib.Path("/JRDB_to_KITTI_V2/")
    # else:
    #     save_path = pathlib.Path(data_path+"/JRDB_to_KITTI_V2/")
    kitti_infos_train = jrdb.get_kitti_image_info(
        save_path,
        training=True,
        velodyne=True,
    ...
    # num_points_in_gt = data_path.
    filename = save_path + target_train_pickle_name 
    print(f"Kitti info train file is saved to {filename}")
    with open(filename, 'wb') as f:
        pickle.dump(kitti_infos_train, f)
    
    # if save_path is None:
    #     save_path = pathlib.Path(val_data_path)
    # else:
    #     save_path = pathlib.Path(val_data_path)
    kitti_infos_val = jrdb.get_kitti_image_info(
        save_path,
        training=True,
        velodyne=True,
        calib=True,
    ...
    filename = save_path + target_val_pickle_name
    ...
    #     relative_path=relative_path)
    # filename = save_path / 'JRDB_to_kitti_infos_test.pkl'
