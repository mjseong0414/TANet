...
def compute_statistics_jit(overlaps,
    ...
    for i in range(gt_size):
        ...
        if (valid_detection == NO_DETECTION) and ignored_gt[i] == 0:
            ...
            # print("111111111111111111111111111111111 >>>> ", tp)
            # only a tp add a threshold.
            tp += 1
            # print("2222222222222222222222222222222222222 >>>> ", det_idx)
            # print("33333333333333333333333333333333333333 >>>> ", thresh_idx)
            # thresholds.append(dt_scores[det_idx])
            thresholds[thresh_idx] = dt_scores[det_idx]
            # print("44444444444444444444444444444444444444 >>>> ", dt_scores)
            # print("55555555555555555555555555555555555555555 >>>> ", thresholds)
            thresh_idx += 1
            if compute_aos:
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, difficultys=[0, 1, 2], return_data=False, bev_target = None):
    ...
    overlap_0_5 = np.array([[0.7, 0.5, 0.5, 0.7, 0.5, 0.5, 0.5, 0.5],
                            ...
                            [0.5, 0.25, 0.25, 0.5, 0.25, 0.5, 0.5, 0.5]])
    overlap_0_3 = np.array([[0.7, 0.3, 0.5, 0.7, 0.5, 0.5, 0.5, 0.5],
                            [0.5, 0.3, 0.25, 0.5, 0.25, 0.5, 0.5, 0.5],
                            [0.5, 0.3, 0.25, 0.5, 0.25, 0.5, 0.5, 0.5]])
